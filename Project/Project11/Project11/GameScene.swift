       ...
       // removeTouches(in: box)
        ...
        if objects.contains(editLabel){
            ...
            if editingMode{
                ...
                box.name = "randomrect"
                print(box)
                rectArray.append((box.physicsBody?.node)!)
                print("rect array \(rectArray)")
               // print("rect array count \(rectArray.count)")
...
//        }
        ...
        if contact.bodyA.node?.name == "randomrect"{
